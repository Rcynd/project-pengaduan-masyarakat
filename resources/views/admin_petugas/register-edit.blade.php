        ...
        <div class="col-12">
          <div class="card glass-card-t">
            ...
            <div class="card-body table-responsive p-0">
                <div class="">
                    <!-- form start -->
                    <form method="post" action="{{ asset('') }}registrasi/edit/{{ $user->username }}" class="mb-5" enctype="multipart/form-data">
                        @csrf
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          @enderror
                          <input type="text" class="form-control rounded-pill" id="nama_petugas" value="{{ old('nama_petugas', $user->nama_petugas) }}" name="nama_petugas" placeholder="Enter nama_petugas">
                        </div>
                        <div class="form-group">
                          ...
                          @error('username')
                            <p class="text-danger">{{ $message }}</p>
                          @enderror
                          <input type="text" class="form-control rounded-pill" id="username" value="{{ old('username', $user->username) }}" name="username" placeholder="Enter username">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @error('telp')
                              <p class="text-danger">{{ $message }}</p>
                            @enderror
                            <input type="text" class="form-control rounded-pill" id="telp" value="{{ old('telp', $user->telp) }}" name="telp" placeholder="Enter No telepon">
                        </div>
                        <div class="form-group">
